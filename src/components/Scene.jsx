...
import { OrbitControls, Grid, Environment, Sky, Stars } from '@react-three/drei';
    ...
    return (
        <div style={{ width: '100vw', height: '100vh', background: isNight ? '#050510' : '#87CEEB', transition: 'background 1s ease' }}>
            <Canvas camera={{ position: [0, 2, 8], fov: 50 }}>
                ...
                <pointLight position={[-10, 10, -10]} intensity={isNight ? 0.2 : 0.5} />

                {/* Ground helper */}
                <Grid infiniteGrid sectionColor={isNight ? "#444444" : "#ffffff"} cellColor={isNight ? "#222222" : "#aaaaaa"} fadeDistance={30} sectionThickness={1} cellThickness={0.5} />
